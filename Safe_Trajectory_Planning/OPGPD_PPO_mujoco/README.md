...
python train_opgpdppo_pointnav.py \
  --config config_pointnav_p3o.json \
  --epochs 100 \
  --num_roll_out 15 \
  --max_ep_len 1000 \
...
python train_opgpdppo_pointnav.py \
  --config config_pointnav_OPGPD.json \
  --epochs 100 \
  --num_roll_out 15 \
  --max_ep_len 1000 \
  --rollout_parallel 16 \
...
python eval_opgpdppo_pointnav.py --config config_pointnav_OPGPD.json \
  --checkpoint runs_pointnav_opgpd/ckpt_20260131_135130_epoch_080.pt \
  --num_episodes 5 \
  --save_mp4_each --render_width 1920 --render_height 1080 \
  --camera_id 1
