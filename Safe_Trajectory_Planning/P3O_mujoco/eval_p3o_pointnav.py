...
Evaluate a saved checkpoint on Safety-Gymnasium point navigation.
...
) -> Tuple[RewardCostWrapper, P3OAgent]:
...
@torch.no_grad()
def rollout_frames(env: RewardCostWrapper, agent: P3OAgent, max_steps: int, seed: int | None, fps: int, render_kwargs: Dict[str, Any] | None = None):
