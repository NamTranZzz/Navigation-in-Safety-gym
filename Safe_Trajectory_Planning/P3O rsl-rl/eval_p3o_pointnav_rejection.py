...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate P3O policy with rejection sampling on cost limit.")
    p.add_argument("--config", type=str, default="config_pointnav_P3O_DynObs.json")
...
def make_policy(config: Dict[str, Any], checkpoint: str, device: str, seed: int):
    ...
    runner_cfg = build_train_cfg(p3o_cfg, experiment_name="eval", run_name="eval")
