...
Runnable entrypoint:
- Builds Gazebo point navigation env (Gymnasium wrapper)
...
def main():
    ...
    env_cfg = GazeboPointNavConfig(**cfg["env"])
    env = GazeboPointNavEnv(env_cfg, render_mode=("human" if args.live else None))
    ...
    print("[Defaults] kappa=20, gamma=0.99, lam=0.97, clip=0.2 (paper Navigation defaults)")
